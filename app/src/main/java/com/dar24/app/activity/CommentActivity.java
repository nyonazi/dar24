...
public class CommentActivity extends BaseAppCompatActivity {
    ...
    private void loadComments() {
        ...
        String html = "<!doctype html> <html lang=\"en\"> <head></head> <body> " +
                ...
                "js.id = id; " +
                "js.src = \"//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.6\"; fjs.parentNode.insertBefore(js, fjs); }(document, 'script', 'facebook-jssdk'));</script> " +
                "<div class=\"fb-comments\" data-href=\"" + postUrl + "\" " +
                "data-numposts=\"" + NUMBER_OF_COMMENTS + "\" data-order-by=\"reverse_time\">" +
                "</div> </body> </html>";

        mWebViewComments.loadDataWithBaseURL("http://dar24.com", html, "text/html", "UTF-8", null);
